    ...
    <nav class="side">
        ...
        <div class="main">
            ...
            <div class="main">
                ...
                <div class="directory">
                    <p><a href="dashboardadmin.php">Dashboard</a> > Tasks</p>
                </div>
                    ...
                    <input type="text" id="searchInput" placeholder="Search...">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Program</th>
                                <th>Description</th>
                                <th>Assignee</th> <!-- Add the Actions table header -->
                                <th>Due Date</th>
                                <th>Status</th>
                                <th>Actions</th>
                            </tr>
                            ...
                            <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>" . $row["TaskID"] . "</td>"; // Display task ID
                                        // Check if the "Program" key exists in the $row array
                                        if (isset($row["Program"])) {
                                            echo "<td>" . $row["Program"] . "</td>"; // Display program
                                        } else {
                                            echo "<td>No Program</td>"; // Display a placeholder if "Program" key is not found
                                        }
                                        echo "<td>" . shortenDescription($row["Description"], 7) . "</td>";
                                        echo "<td>" . $row["Assignee"] . "</td>"; // Display assignee
                                        echo "<td>" . $row["DueDate"] . "</td>"; // Display due date
                                        echo "<td>" . $row["Status"] . "</td>"; // Display status
                                        // Add Edit and Delete buttons if necessary
                                        echo "<td><button onclick=\"toggleEditForm('" . $row["TaskID"] . "')\">Edit</button><button onclick=\"confirmDelete('" . $row["TaskID"] . "')\">Delete</button></td>";
                                        echo "</tr>";
                                    }
                                } else {
