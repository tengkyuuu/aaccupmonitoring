                    ...
                    <input type="text" id="searchInput" placeholder="Search...">
                        ...
                        <thead>
                            ...
                            <?php
                                ...
                                // Display department data in the table
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>" . $row["Name"] . "</td>"; // Display department name
                                        echo "<td>" . $row["UniversityID"] . "</td>"; // Display university ID
                                        echo "<td>" . $row["ContactInformation"] . "</td>"; // Display contact information
                                        // Add the Edit and Delete buttons here
                                        echo "<td><button onclick=\"toggleEditForm('" . $row["DepartmentID"] . "', '" . $row["Name"] . "', '" . $row["UniversityID"] . "', '" . $row["ContactInformation"] . "')\">Edit</button><button onclick=\"confirmDelete('" . $row["DepartmentID"] . "')\">Delete</button></td>";
                                        echo "</tr>";
                                    }
                                } else {
